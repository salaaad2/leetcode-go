...
fn main()
{
    ...
    // let mut result = measure_time(Solution::contains_duplicate, &&nums4);
    // println!("Time taken: {} ns", result);
    // result = measure_time(Solution::contains_duplicate, &&nums4);
    // println!("Time taken: {} ns", result);
    // result = measure_time(Solution::contains_duplicate, &&nums4);
    // println!("Time taken: {} ns", result);
    // result = measure_time(Solution::contains_duplicate, &&nums4);
    ...
    // result = measure_time(Solution::contains_duplicate_hashmap, &&nums4);
    // println!("Time taken: {} ns", result);
    // result = measure_time(Solution::contains_duplicate_hashmap, &&nums4);
    // println!("Time taken: {} ns", result);
    // result = measure_time(Solution::contains_duplicate_hashmap, &&nums4);
